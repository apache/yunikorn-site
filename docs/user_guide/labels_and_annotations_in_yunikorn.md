...
| `namespace.enableYuniKorn`          | Controls which namespace will have pods forwarded to Yunikorn for scheduler. Further details can be found in the [Service Configuration #admission-controller-filtering-settings](./service_config.md#admission-controller-filtering-settings) documentation.                                                                                                                                                                                                                                           |
| `namespace.generateAppId`           | Controls which namespaces will have pods labeled with an `applicationId`. Further details can be found in the [Service Configuration #admission-controller-filtering-settings](./service_config.md#admission-controller-filtering-settings) documentation.                                                                                                                                                                                                                                             |
