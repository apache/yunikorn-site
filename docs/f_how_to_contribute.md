...
For help with reporting issues look at the [how to report an issue](f_reporting_issues.md).
...
Make sure you have observed the recommendations in the [coding guidelines](f_coding_guidelines.md).
